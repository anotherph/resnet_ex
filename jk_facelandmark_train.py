...
class FaceLandmarksDataset(Dataset):
    ...
    def __init__(self, transform=None):
        ...
        tree = ET.parse('./face_dataset/ibug_300W_large_face_landmark_dataset/labels_ibug_300W_train.xml')
        root = tree.getroot()
        ...
        self.root_dir = './face_dataset/ibug_300W_large_face_landmark_dataset'
...
if __name__ == "__main__":
    ...
    # '''visulize'''
    # file = open('./face_dataset/ibug_300W_large_face_landmark_dataset/helen/trainset/100032540_1.pts')
    ...
    # plt.imshow(mpimg.imread('./face_dataset/ibug_300W_large_face_landmark_dataset/helen/trainset/100032540_1.jpg'))
